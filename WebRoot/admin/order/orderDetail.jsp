...
<html>
  ...
  <body class="body" leftmargin="0" rightmargin="0">
     <table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#F7F3F7">
          <tr height="26">
              <td class="blackTitle" align="center">车次编号</td>
              <td class="blackTitle" align="center">车次日期</td>
              <td class="blackTitle" align="center">车次线路</td>
              <td class="blackTitle" align="center">车票类型</td>
		  ...
		  <tr class="text" align="center" bgcolor="#FFFFFF">
			  <td>${orderitem.checi.bianhao}</td>
			  <td>${orderitem.checi.riqi}</td>
			  <td>${orderitem.checi.shifadi}-${orderitem.checi.daodadi}</td>
			  <td>${orderitem.piaoleixing}</td>
			  <td>${orderitem.danjia}</td>
			  <td>${orderitem.shuliang}</td>
		  </tr>
		  </c:forEach>
  	</table>
  </body>
